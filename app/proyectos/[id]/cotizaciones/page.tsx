...
export default function CotizacionEditorPage() {
  ...
  if (!cotId) return <div style={{ color: "#dc2626", padding: 24, fontSize: 13 }}>Error: ID de cotización no encontrado. Vuelve al proyecto e intenta de nuevo.</div>
  ...
  return (
    <div>
            ...
            <label style={{ display: "block", fontSize: 11, color: "#6b7280", marginBottom: 4 }}>
              <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <label style={{ display: "flex", alignItems: "center", gap: 4, cursor: "pointer" }}>
                  ...
                  <span style={{ fontSize: 10, color: feeActivo ? "#0F6E56" : "#9ca3af" }}>{feeActivo ? "Activo" : "No aplica"}</span>
                </label>
              </span>
            </label>
      ...
      <div className="card" style={{ padding: 0, overflow: "hidden", marginBottom: 16 }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
                          <div>
                            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
                              <div style={{ fontSize: 11, fontWeight: 700, color: "#0F6E56", textTransform: "uppercase", letterSpacing: "0.06em" }}>
        ...
        <div style={{ padding: "12px 16px", borderTop: items.length > 0 ? "1px solid #f3f4f6" : "none" }}>
      ...
      <div style={{ background: "#E1F5EE", border: "1px solid #1D9E75", borderRadius: 12, padding: "16px 24px", display: "flex", gap: 28, flexWrap: "wrap", alignItems: "center" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          <div style={{ fontSize: 10, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em", color: "#085041" }}>Subtotal costo</div>
          <div style={{ fontSize: 18, fontWeight: 700, color: "#dc2626" }}>{fmt(totalCosto)}</div>
        </div>
        {feeActivo && (
          <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
            <div style={{ fontSize: 10, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em", color: "#085041" }}>Fee agencia ({feePct}%)</div>
            <div style={{ fontSize: 18, fontWeight: 600, color: "#374151" }}>{fmt(feeMonto)}</div>
          </div>
        )}
        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          <div style={{ fontSize: 10, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em", color: "#085041" }}>Subtotal cliente</div>
          <div style={{ fontSize: 18, fontWeight: 600, color: "#374151" }}>{fmt(subtotalConFee)}</div>
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          <div style={{ fontSize: 10, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em", color: "#085041" }}>IGV ({igvPct}%)</div>
          <div style={{ fontSize: 18, fontWeight: 600, color: "#374151" }}>{fmt(igvMonto)}</div>
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          <div style={{ fontSize: 10, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em", color: "#085041" }}>Total cliente</div>
          <div style={{ fontSize: 22, fontWeight: 800, color: "#04342C" }}>{fmt(totalFinal)}</div>
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          <div style={{ fontSize: 10, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em", color: "#085041" }}>Margen neto</div>
