...
const TIPOS: Record<string, any> = {
  ...
  retorno:  { label: "Retorno",  icon: "↩️", color: "#6d28d9", bg: "#f5f3ff" },
                        ...
                        <div style={{ display: "flex", gap: 5, justifyContent: "flex-end", flexWrap: "wrap" }}>
                          ...
                          {e.estado === "aprobado" && (
                            <button onClick={() => cambiarEstado(e.id, "en_transito")}
                              style={{ fontSize: 11, padding: "3px 8px", border: "1px solid #fde68a", borderRadius: 6, background: "#fff", color: "#92400e", cursor: "pointer" }}>En tránsito</button>
                          )}
