...
const ACCESO: Record<string, string[]> = {
  ...
  gerente_finanzas: ["/dashboard","/proyectos","/rq","/facturacion","/liquidaciones","/conciliacion","/flujo-caja","/centro-costos","/caja-chica","/gastos-oficina","/prestamos","/clientes","/ia","/alertas","/perfil","/tareas","/reporteria"],
