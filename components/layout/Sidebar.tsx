...
const ACCESO: Record<string, string[]> = {
  ...
  gerente_produccion: ["/dashboard","/proyectos","/calendario","/gestor","/clientes","/proformas","/biblioteca","/rq","/liquidaciones","/caja-chica","/inventario","/envios-materiales","/rrhh","/ia","/trazabilidad","/alertas","/perfil","/tareas"],
  ...
  productor: ["/dashboard","/proyectos","/calendario","/gestor","/clientes","/proformas","/biblioteca","/rq","/liquidaciones","/caja-chica","/envios-materiales","/ia","/alertas","/rrhh/vacaciones","/rrhh/horas-extras","/rrhh/permisos","/rrhh/faltas-medicas","/rrhh/trabajadores","/perfil","/tareas"],
